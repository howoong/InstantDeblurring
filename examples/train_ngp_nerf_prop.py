...
parser.add_argument(
    ...
    type=str,
    default="lego",
    choices=NERF_SYNTHETIC_SCENES + MIPNERF360_UNBOUNDED_SCENES + LLFF_SCENES,
...
if args.scene in MIPNERF360_UNBOUNDED_SCENES and args.data_root.split("/")[-1] != "nerf_llff_data":
...
elif args.scene in LLFF_SCENES:
...
logdir = f"./log2/{args.scene}_{args.tag}"
...
for step in range(max_steps + 1):
    ...
    if step > 0 and step % max_steps == 0:
        ...
        print(f"prop_{args.scene}_{args.tag}_evaluation: psnr_avg={psnr_avg}, lpips_avg={lpips_avg}")
        with open("./res.txt", "a") as f:
            f.write(f"prop_{args.scene}_{args.tag}: psnr_avg={psnr_avg:.2f}, lpips_avg={lpips_avg:.4f}\n")
